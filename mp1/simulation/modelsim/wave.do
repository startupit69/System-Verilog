...
add wave -noupdate -label pc_out /mp1_tb/dut/datapath/pc/out
...
add wave -noupdate {/mp1_tb/dut/datapath/regfile/data[7]}
add wave -noupdate {/mp1_tb/dut/datapath/regfile/data[6]}
add wave -noupdate {/mp1_tb/dut/datapath/regfile/data[5]}
add wave -noupdate {/mp1_tb/dut/datapath/regfile/data[4]}
add wave -noupdate {/mp1_tb/dut/datapath/regfile/data[3]}
add wave -noupdate {/mp1_tb/dut/datapath/regfile/data[2]}
add wave -noupdate {/mp1_tb/dut/datapath/regfile/data[1]}
add wave -noupdate {/mp1_tb/dut/datapath/regfile/data[0]}
