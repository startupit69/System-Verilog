...
add wave -noupdate -label pc_out /mp2_tb/dut/datapath/pc_out
add wave -noupdate -label mem_address /mp2_tb/dut/datapath/mem_address
add wave -noupdate -label mem_read /mp2_tb/mem_read
add wave -noupdate -label mem_rdata /mp2_tb/dut/datapath/mem_rdata
...
add wave -noupdate -label registers -expand /mp2_tb/dut/datapath/regfile/data
